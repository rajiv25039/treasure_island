...
#Choice - 1
choice_1 = input("You are on a cross road. Which way, you want to go? Tpe 'left' or 'right'\n ").lower()
...
if choice_1 == "left":
  ...
  if choice_2 == "wait":
    ...
    if choice_3 == "red":
      ...
      print("You entered in a room full of beast. Game Over.")
    else: 
      print("You choose a door which do not exist. Game Over.")
